<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"E:\PHPTools\www\leqiubaobeipc\public/../application/admin\view\product\video\edit.html";i:1538114440;s:72:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\layout\default.html";i:1536636085;s:69:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\common\meta.html";i:1536636085;s:71:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\common\script.html";i:1536636085;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-thumbimage" data-rule="required" class="form-control form-control" size="50" name="row[thumbimage]" type="text" value="<?php echo $row['thumbimage']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-description" data-rule="required" class="form-control form-control" name="row[description]" type="text" value="<?php echo $row['description']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Weigh'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-weigh" class="form-control form-control" name="row[weigh]" type="number" value="<?php echo $row['weigh']; ?>">
        </div>
    </div>
