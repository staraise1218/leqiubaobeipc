<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"E:\PHPTools\www\leqiubaobeipc\public/../application/admin\view\product\video\add.html";i:1537512718;s:72:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\layout\default.html";i:1536636085;s:69:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\common\meta.html";i:1536636085;s:71:"E:\PHPTools\www\leqiubaobeipc\application\admin\view\common\script.html";i:1536636085;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-videofile" data-rule="required" class="form-control form-control" size="50" name="row[videofile]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-description" data-rule="required" class="form-control form-control" name="row[description]" type="text">
        </div>
    </div>
